...
if __name__ == "__main__":
    ...
    # --- Custom line calibration ---
    # Set specific s_nom values (in MW) per line; line '3' is removed entirely.
    ...
    n.mremove("Line", ['3'])
    logger.info("Removed line '3'.")

    for line_name, s_nom_value in line_calibration.items():
        n.lines.loc[line_name, 's_nom'] = s_nom_value
        logger.info(f"Set line '{line_name}' s_nom to {s_nom_value} MW.")

    # --- End custom line calibration ---
    for o in opts:
